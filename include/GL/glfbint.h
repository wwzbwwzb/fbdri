#ifndef __GLFB_glfbint_h__
#define __GLFB_glfbint_h__

/* $XFree86: xc/include/GL/glxint.h,v 1.3 2000/11/18 19:37:04 tsi Exp $ */
/*
** The contents of this file are subject to the GLFB Public License Version 1.0
...
**
** The Original Software is GLFB version 1.2 source code, released February,
...
typedef struct __GLFBvisualConfigRec __GLFBvisualConfig;

#include "glfb.h"
#include "GL/xreplacements.h"

struct __GLFBvisualConfigRec {
//    VisualID vid;
    int class;
    Bool rgba;
...
#define __GLFB_MIN_CONFIG_PROPS	18
#define __GLFB_MAX_CONFIG_PROPS	500

#define __GLFB_EXT_CONFIG_PROPS 	7
...
** the new properties. 
*/
#define __GLFB_TOTAL_CONFIG       (__GLFB_MIN_CONFIG_PROPS +      \
                                    2 * __GLFB_EXT_CONFIG_PROPS)

#endif /* !__GLFB_glfbint_h__ */
