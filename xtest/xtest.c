...
//printf("draw_thing 9\n");
	glVertex3f(-CUBE_WIDTH / 2, CUBE_HEIGHT / 2, CUBE_DEPTH / 2);
//printf("draw_thing 10\n");

	glTexCoord2f(0.0, (float)IMAGE_HEIGHT / 2048);   
	glVertex3f(-CUBE_WIDTH / 2, -CUBE_HEIGHT / 2, CUBE_DEPTH / 2);
//printf("draw_thing 11\n");

	glTexCoord2f((float)IMAGE_WIDTH / 2048, (float)IMAGE_HEIGHT / 2048);   
	glVertex3f(CUBE_WIDTH / 2, -CUBE_HEIGHT / 2, CUBE_DEPTH / 2);
//sleep(1);
//printf("draw_thing 12\n");

	glEnd();
//sleep(1);
//printf("draw_thing 13\n");


    glDisable(GL_TEXTURE_2D);
//sleep(1);
//printf("draw_thing 14\n");


	glFlush();


//printf("draw_thing 15\n");




    glPopMatrix();
//printf("draw_thing 16\n");
}
